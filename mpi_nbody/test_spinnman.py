...
from spinnman.model.diagnostic_filter_packet_type import DiagnosticFilterPacketType
from spinnman.messages.scp.impl.scp_read_memory_request import SCPReadMemoryRequest
from spinnman.model.diagnostic_filter_destination import DiagnosticFilterDestination
...
transceiver = create_transceiver_from_hostname(
    'spin5.polito.it', 5,
    ignore_cores=down_cores, ignore_chips=down_chips,
    bmp_connection_data=[spinnman.model.bmp_connection_data.BMPConnectionData(0, 0, 'bmp-spin5.polito.it', [0], None)],
...
try:
    ...
    print "Execute Flood"
    print "============="
    file_name = "sdp_over_mc.aplx"
    file_size = os.stat(file_name).st_size
    executable = FileDataReader(file_name)
